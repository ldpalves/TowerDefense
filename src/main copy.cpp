...
void DrawVirtualObject(GameObject game_object); // Desenha um objeto armazenado em g_VirtualScene
...
int main(int argc, char* argv[])
{
    ...
    //GameObject mybunny(1,17,20);

    //int bunnyx = mybunny.get_x();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //GameObject sphere(0,"Sphere", model);        
        //DrawVirtualObject(sphere);

        // Desenhamos o modelo do coelho
        //model = Matrix_Translate(0.0f,1.0f,0.0f)* Matrix_Scale(0.5f,0.5f,0.5f);
        //GameObject bunny(1,"Bunny", model);
        //DrawVirtualObject(bunny);

        // Desenhamos o plano do chão
        //model = Matrix_Scale(2.0f, 1.0f, 2.0f) * Matrix_Translate(0.0f,0.0f,0.0f);
        //GameObject plane(2,"Plane", model);
...
void DrawVirtualObject(GameObject game_object)
{
    glUniformMatrix4fv(model_uniform, 1 , GL_FALSE , glm::value_ptr(game_object.getModel()));
    glUniform1i(object_id_uniform, game_object.getId());

    const char* object_name = game_object.getName();
